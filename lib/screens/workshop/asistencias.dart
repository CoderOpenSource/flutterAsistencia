...
class AsistenciasDocenteScreen extends StatefulWidget {
  const AsistenciasDocenteScreen({super.key});

  @override
  _AsistenciasDocenteScreenState createState() =>
      _AsistenciasDocenteScreenState();
}

class _AsistenciasDocenteScreenState extends State<AsistenciasDocenteScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Asistencias del Docente'),
