...
class FaltasDocenteScreen extends StatefulWidget {
  const FaltasDocenteScreen({super.key});

  @override
  _FaltasDocenteScreenState createState() => _FaltasDocenteScreenState();
}

class _FaltasDocenteScreenState extends State<FaltasDocenteScreen> {
      ...
      setState(() {
        asistencias = jsonResponse
            ...
            .where((asistencia) =>
                ...
                asistencia.estadoAsistenciaId == 3)
            .toList();
      });
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Faltas del Docente'),
